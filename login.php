...
<head>
    ...
    <style>
        ...
        body {
            /* background-image: url('asset/img/belakang.png'); */
        ...
        .card {
            background: rgba(255, 255, 255, 0.8); /* Transparansi opsional */
            width: 100%;
                ...
                <div class="column is-8"> <!-- Lebar kolom ditingkatkan -->
                    <div class="card">
                        <div class="card-header">
                            <p class="card-header-title">PEMILIHAN PEPTISIDA TERBAIK UNTUK PADI METODE WEIGHTD PRODUCT</p>
                        </div>
