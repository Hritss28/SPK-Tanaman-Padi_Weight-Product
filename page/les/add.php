                            ...
                            <form action="" method="post">
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Kode Alternatif, Contoh : A1" name="kode_alternatif">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="Nama Peptisida" name="nm_les">
                                        <span class="icon is-small is-left">
