...
$id = $_GET["id"];
$query = Index("SELECT * FROM perhitungan WHERE id_nilai = $id");
                            ...
                            <form action="" method="post">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        ...
                                        <input class="input" type="text" placeholder="Nilai untuk setiap alternatif (isi angka 1/2/3)" name="nilai" value="<?= $data["nilai"] ?>">
